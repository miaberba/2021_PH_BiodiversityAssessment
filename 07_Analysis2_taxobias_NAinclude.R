...
#     taxonomic biases. The process involves comparing the amount of species and 
#     genetic data available for each taxon at different taxonomic levels 
#     (i.e., phylum, class, order, and family). Here, the barcode data analyzed 
#     INCLUDES records that are NA for the country sampled, despite searches 
...
pdf("./Figures_unedited/geneXspecies_phylum_NAinclude.pdf", paper = "a4r")
...
#   NOTE: include lines to represent 5th and 95th percentile of both datasets
pdf("./Figures_unedited/geneXspecies_class_NAinclude.pdf", paper = "a4r")
...
#   NOTE: include lines to represent 5th and 95th percentile of both datasets
pdf("./Figures_unedited/geneXspecies_order_NAinclude.pdf", paper = "a4r")
...
#   NOTE: include lines to represent 5th and 95th percentile of both datasets
pdf("./Figures_unedited/geneXspecies_family_NAinclude.pdf", paper = "a4r")
