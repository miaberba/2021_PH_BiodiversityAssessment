...
#     geolocation, and taxonomic information. The process is exactly the same as
#     the previous script (07) designated to analyzing metadata gaps however, 
#     here, the barcode data analyzed EXCLUDES records that are NA for the  
#     country sampled, despite searches being filtered geographically. 
...
# check total number of records in barcode_data_final - NAexclude
...
pdf("./Figures_unedited/GeneMarker_summary_NAexclude.pdf", paper = "a4r")
...
pdf("./Figures_unedited/GeoIssues_summary_NAexclude.pdf", paper = "a4r")
...
pdf("./Figures_unedited/SpeciesID_phylum_NAexclude.pdf", paper = "a4r")
...
gene_clsp <- barcode_data_final[ , unique(species), by = .(classUse)]
...
pdf("./Figures_unedited/SpeciesID_class_NAexclude.pdf", paper = "a4r")
...
gene_ordsp <- barcode_data_final[ , unique(species), by = .(orderUse)]
...
pdf("./Figures_unedited/SpeciesID_order_NAexclude.pdf", paper = "a4r")
...
gene_famsp <- barcode_data_final[ , unique(species), by = .(familyUse)]
...
pdf("./Figures_unedited/SpeciesID_family_NAexclude.pdf", paper = "a4r")
